...
public class GrapheLivraison implements Graph {
	...
	/**
	 * M�thode de calcul de l'ordre des livraisons en fonction des chemins entre elles
	 * @return List Livraison : La liste ordonn�e des livraisons si la tournee specifiee est realisable, null sinon
	 */
	 ...
	 * @param idLivraison int : identifiant de la livraison � retrouver
	 * @return Livraison : 
	 */
